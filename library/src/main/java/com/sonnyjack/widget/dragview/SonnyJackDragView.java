...
public class SonnyJackDragView implements View.OnTouchListener {
    ...
    private void initDragView() {
        ...
        FrameLayout.LayoutParams layoutParams = createLayoutParams(left, mScreenHeight - (mBuilder.defaultButtom + mBuilder.size), 0, 0);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                top = v.getTop() + dy;
                if (top < mStatusBarHeight + mBuilder.toolBarSize) {
                    top = mStatusBarHeight + mBuilder.toolBarSize;
                }
                bottom = top + v.getHeight();
                if (bottom > mScreenHeight - mBuilder.btSize) {
                    bottom = mScreenHeight - mBuilder.btSize;
...
//        }
    ...
    public static class Builder {
        ...
        private int toolBarSize = 0;
        private int btSize = 0;
        private int defaultTop = 0;
        private int defaultButtom = 0;
        ...
        public Builder setToolBarSize(int toolBarSize) {
            this.toolBarSize = toolBarSize;
            return this;
        }

        public Builder setBottomMaxSize(int btSize) {
            this.btSize = btSize;
            return this;
        }
        ...
        public Builder setDefaultButtom(int buttom) {
            this.defaultButtom = buttom;
            return this;
        }
